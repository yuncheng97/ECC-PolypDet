...
class ResNet50(nn.Module):
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load('./snapshot/resnet50-11ad3fa6.pth'))
        self.inner_channels = [256, 512, 1024, 2048]
...
class ResNet101(nn.Module):
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load('./snapshot/resnet101-cd907fc2.pth'))
